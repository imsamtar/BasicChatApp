...
<form class="form" on:submit|preventDefault={signup}>
	...
	<div class="flex">
		<div>
			...
			<input type="text" class="input is-primary"  bind:value={user.profile.firstName} placeholder="John">
		</div>
		<div>
			<label for="lastName" class="label">Last Name:</label>
			<input type="text" class="input is-primary"  bind:value={user.profile.lastName} placeholder="Doe">
		</div>
	</div>
	<label for="email" class="label">Email:</label>
	<div class="control has-icons-left has-icons-right">
		<input type="email" class="input is-primary email" bind:value={user.email} placeholder="username@example.com">
